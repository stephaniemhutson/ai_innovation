...
# def extract_spec(xml_string, sections=None):
#     """
...
#             for child in p:
#                 if child.tag not in [
#                     '{urn:us:gov:doc:uspto:common}PartName',
#                     '{urn:us:gov:doc:uspto:common}PartNumber',
#                     '{urn:us:gov:doc:uspto:common}OCRConfidenceData'
#                 ]:
#                     if child.text:
...
#                     current_section = element['text'].upper()
#                     include_current = current_section in sections_upper
#                     if include_current:
